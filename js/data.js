...
export const QUESTIONS = [
  ...
  mcq('c7-m1', 'c7', 'medium', 'Tính 2/5 × 5/6 (viết kết quả ở dạng tối giản):', ['7/11', '1/3', '37/30', '12/25'], 1, 'Nhân tử với tử, mẫu với mẫu: 2/5 × 5/6 = (2×5)/(5×6) = 10/30 = 1/3 sau khi rút gọn.'),
  mcq('c7-m2', 'c7', 'medium', 'Tính 3/4 : 1/2 (viết kết quả ở dạng tối giản):', ['3/8', '3/2', '2/3', '1/4'], 1, 'Chia phân số là nhân với phân số nghịch đảo: 3/4 : 1/2 = 3/4 × 2/1 = 6/4 = 3/2 sau khi rút gọn.'),
  ...
  mcq('c7-h3', 'c7', 'hard', 'Tìm x, biết x × 2/3 = 4/9.', ['x = 2/3', 'x = 8/27', 'x = 3/2', 'x = 2/9'], 0, 'x = (4/9) : (2/3) = 4/9 × 3/2 = 12/18 = 2/3.'),
  ...
  mcq('c8-e3', 'c8', 'easy', 'Làm tròn số 7,86 đến hàng đơn vị:', ['7', '8', '7,9', '9'], 1, 'Chữ số hàng phần mười là 8 (≥5) nên làm tròn hàng đơn vị lên: 7,86 ≈ 8.'),
