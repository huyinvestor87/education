...
export const QUESTION_EN = {
  ...
  'c7-m1': ['Work out 2/5 × 5/6:', ['10/30', '1/3', '2/6', '7/11'], '2/5 × 5/6 = 10/30 = 1/3 after simplifying.'],
  'c7-m2': ['Work out 3/4 : 1/2:', ['3/8', '3/2', '2/3', '6/4'], '3/4 : 1/2 = 3/4 × 2/1 = 6/4 = 3/2.'],
  ...
  'c7-h3': ['Find x, given x × 2/3 = 4/9.', ['x = 2/3', 'x = 8/27', 'x = 6/9', 'x = 2/9'], 'x = (4/9) : (2/3) = 4/9 × 3/2 = 12/18 = 2/3.'],
  ...
  'c8-e3': ['Round 7.86 to the nearest whole number:', ['7', '8', '7.9', '8.0'], 'The tenths digit is 8 (≥5), so we round up: 7.86 ≈ 8.'],
